...
$plugin_name = 'build_tinydns';

// Set a title
$window['title'] = "Build TinyDNS Install";
...
$reqfile = $onainstalldir.'/bin/build_tinydns';
if (file_exists($reqfile)) {
    $window['html'] .= "&nbsp;&nbsp;&nbsp;&nbsp;<img src='{$images}/silk/accept.png' border='0'> {$reqfile}<br>";
} else {
    $stat++;
    $window['html'] .= "&nbsp;&nbsp;&nbsp;&nbsp;<img src='{$images}/silk/error.png' border='0'> <font color=\"red\">ERROR=> Install build script:</font><br>";
    // Provide some information to the user on how to fix the problem manually
    $window['html'] .= "<font color=\"orange\">Execute shell command:<br>ln -s {$installdir}/build_tinydns {$reqfile}</font><br><br>";
}
